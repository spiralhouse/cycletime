...
set CLASSPATH=%APP_HOME%\lib\jcvd-server.jar

@rem Execute jcvd-kotlin
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %JCVD_KOTLIN_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%JCVD_KOTLIN_EXIT_CONSOLE%" exit 1
exit /b 1
