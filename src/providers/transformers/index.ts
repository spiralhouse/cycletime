...
export class TransformerRegistry {
   ...
   */
  listTransformers(): Array<{ id: string; transformer: ProviderTransformerBase }> {
...
export class TransformationBenchmark {
  ...
  getSummary(): {
    ...
    const averageItemsPerSecond = totalItems > 0 && totalDuration > 0 ? 
      (totalItems / totalDuration) * 1000 : 0
...
export class TransformationValidator {
  ...
  static validateConfig(config: {
    ...
    const validEntityTypes: EntityType[] = ['project', 'issue', 'workflowState', 'dependency', 'label', 'comment']
