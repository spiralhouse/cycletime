...
import io.spiralhouse.jcvd.application.dto.ProjectDto
import io.spiralhouse.jcvd.application.dto.ProjectListDto
import io.spiralhouse.jcvd.application.exceptions.ProjectNotFoundException
import io.spiralhouse.jcvd.application.exceptions.ValidationException
...
class ProjectApplicationService(
     ...
     * @throws ProjectNotFoundException if the project doesn't exist
     * @throws io.spiralhouse.jcvd.domain.exceptions.DomainException if project is not ACTIVE
     */
     ...
     * @throws ProjectNotFoundException if the project doesn't exist
     * @throws io.spiralhouse.jcvd.domain.exceptions.DomainException if project is ARCHIVED
     */
