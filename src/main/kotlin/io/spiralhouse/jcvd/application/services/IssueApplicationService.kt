...
import io.spiralhouse.jcvd.application.exceptions.*
...
class IssueApplicationService(
     ...
     * @throws io.spiralhouse.jcvd.application.exceptions.HierarchyViolationException if hierarchy rules are violated
     * @throws io.spiralhouse.jcvd.application.exceptions.ProjectNotFoundException if project doesn't exist
     * @throws io.spiralhouse.jcvd.domain.exceptions.DomainException if domain rules are violated
     */
     ...
     * @throws io.spiralhouse.jcvd.application.exceptions.IssueNotFoundException if the issue doesn't exist
     * @throws io.spiralhouse.jcvd.domain.exceptions.DomainException if updates violate domain rules
     */
     ...
     * @throws io.spiralhouse.jcvd.application.exceptions.CircularDependencyException if circular dependency detected
     * @throws io.spiralhouse.jcvd.application.exceptions.IssueNotFoundException if either issue doesn't exist
     */
     ...
     * @return IssueDto representing the updated issue
     * @throws io.spiralhouse.jcvd.application.exceptions.InvalidStatusTransitionException if transition is invalid
     * @throws io.spiralhouse.jcvd.application.exceptions.IssueNotFoundException if the issue doesn't exist
     */
