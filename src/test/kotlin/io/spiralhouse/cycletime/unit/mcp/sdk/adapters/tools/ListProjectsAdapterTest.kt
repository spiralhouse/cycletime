...
/**
 * RED Phase tests for list_projects tool adapter.
 *
 * These tests WILL and SHOULD fail in RED phase. This is correct and expected in TDD methodology.
 */
class ListProjectsAdapterTest : StringSpec({

    "should register list_projects tool with SDK" {
        // Given
        ...
        // Then
        tools shouldContain "project_list_projects"
    }

    "should execute list_projects via SDK CallToolRequest" {
        // Given
        val mcpServer = MCPSdkServerTestFactory.createWithProviders()
        val executor = MockSDKToolExecutor(mcpServer.server)
