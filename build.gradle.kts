...
// SPI-655: OpenAPI Specification Generation Task
// Generates OpenAPI 3.0 spec for the CycleTime API
  ...
  "paths": {
    "/api/v1/projects": {
      "get": {
        ...
        "description": "Returns all projects with their associated metadata",
        "responses": {
          "200": {
      ...
      "post": {
        ...
        "description": "Creates a new project with the provided name and description",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
        ...
        "parameters": [
          {
            ...
            "in": "query",
            "required": false,
            "description": "Workflow template (default, bug, feature)",
            "schema": {
              "type": "string",
              "enum": ["default", "bug", "feature"]
            }
          }
        ],
        "requestBody": {
    ...
    "/api/v1/workflows/{id}": {
      "get": {
        ...
        "description": "Returns a single workflow template by its UUID",
        "parameters": [
          {
            "name": "id",
            "in": "path",
        ...
        "responses": {
          "200": {
            "description": "Workflow found and returned",
            "content": {
              "application/json": {
                "schema": {
                  "${'$'}ref": "#/components/schemas/WorkflowResponse"
    ...
    "/api/v1/workflows/{id}/transitions": {
      "post": {
        ...
        "description": "Adds a new transition to a workflow",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/api/v1/projects/{projectId}/issues": {
      "get": {
        ...
        "description": "Returns all issues for a given project",
        "parameters": [
          {
            "name": "projectId",
            "in": "path",
        ...
        "responses": {
          "200": {
            "description": "List of issues returned successfully",
            "content": {
              "application/json": {
                "schema": {
                  "type": "array",
    ...
    "/api/v1/projects/{projectId}/issues/{issueId}": {
      "get": {
        ...
        "description": "Returns a single issue from a project",
        "parameters": [
          {
            "name": "projectId",
            "in": "path",
          ...
          },
          {
            ...
            "in": "path",
            "required": true,
            "description": "Issue identifier (UUID)",
            "schema": {
              "type": "string",
              "format": "uuid"
            }
      ...
      "put": {
        ...
        "description": "Updates an issue's properties",
        "parameters": [
          {
            "name": "projectId",
            "in": "path",
  ...
  "components": {
    "schemas": {
      ...
      "ErrorResponse": {
        ...
        val openApiFile = File(projectDir, "openapi/generated.json")
