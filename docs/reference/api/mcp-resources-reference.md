...
type: reference
domain: [api, mcp, resources]
description: "MCP resources specification with URI patterns and resource templates"
dependencies: [../../concepts/mcp/model-context-protocol.md]
related: [mcp-tools-reference.md, rest-api-reference.md]
keywords: [mcp, resources, uri, templates, reference]
