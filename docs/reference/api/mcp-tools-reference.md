...
type: reference
domain: [api, mcp, tools]
description: "Complete MCP tools specification with JSON-RPC examples and parameter details"
...
**Related Documents:**
- [MCP Concepts](../../concepts/mcp/model-context-protocol.md) - Understanding Model Context Protocol
- [MCP Resources Reference](./mcp-resources-reference.md) - Resource specifications
- [REST API Reference](./rest-api-reference.md) - REST endpoints
- [API Quick Start](../../guides/getting-started/api-quick-start.md) - Getting started
- [API Best Practices](../../guides/development/api-best-practices.md) - Development guidelines
