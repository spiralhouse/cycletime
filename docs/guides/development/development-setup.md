...
type: guide
domain: [development, getting-started]
description: "Complete development environment setup with hot-reload, testing, and IDE integration"
dependencies: [../../getting-started/installation-guide.md]
related: [feature-workflow.md, ../../getting-started/quick-start-guide.md]
keywords: [development, setup, hot-reload, testing, ide, gradlew]
