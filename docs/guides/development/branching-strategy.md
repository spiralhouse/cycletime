---
title: "Branching and Worktree Strategy"
type: guide
domain: [development, git]
description: "Standardized branching and worktree patterns for CycleTime development"
dependencies: []
related: [feature-workflow.md, linear-integration.md, ../../reference/worktree-operations.md, ../../reference/decision-guide.md]
keywords: [git, branches, worktree, naming, conventions, strategy]
...
**Integration Details**: See [Linear Integration](linear-integration.md) for complete workflow.
...
- [Single Feature Workflow](feature-workflow.md) - Main directory or single worktree
- [Parallel Development](../testing/parallel-testing-guide.md) - Multiple worktrees
