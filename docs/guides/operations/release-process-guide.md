...
5. **Draft Release Creation** - GitHub Release created in draft mode
6. **Deployment Trigger** - External CD system deploys to dev

### Draft Release Workflow

GitHub releases are automatically created in **draft mode** after each merge to main. This allows DevOps engineers to review and verify release content before publishing.

**What's Included in Draft Releases:**
- ✅ Automated changelog generated by git-cliff
- ✅ All build artifacts (JAR, tar, zip distributions)
- ✅ Version metadata and git SHA
...
gh release edit v0.3.4 --draft=false

# Or use GitHub web UI
# 1. Navigate to: https://github.com/spiralhouse/cycletime/releases
# 2. Click on the draft release
# 3. Review changelog and artifacts
...
5. ✅ Ensure release notes are complete

### Release Approval Gates

- **PR Review** - Quality gates during code review
- **Automated Testing** - Full test suite on merge
- **Draft Review** - DevOps verification before publish
- **Manual Publication** - Explicit release announcement control
