---
title: "Deployment to Staging Guide"
type: guide
domain: [cicd, operations, deployment]
description: "Step-by-step guide for promoting releases to staging environment"
dependencies: [../../concepts/cicd/environment-concept.md]
related: [production-deployment.md, release-process-guide.md]
keywords: [staging, deployment, promotion, operations]
