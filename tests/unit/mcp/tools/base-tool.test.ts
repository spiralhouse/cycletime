...
describe('BaseTool', () => {
  ...
  describe('Capability Management', () => {
    ...
    test('should check if tool has specific capability', () => {
      ...
      const hasCapability = (capability: string) => mockMetadata.capabilities.includes(capability as any);
  ...
  describe('Availability Checking', () => {
    test('should allow custom availability checking', () => {
      ...
      const setAvailable = (newAvailable: boolean) => { available = newAvailable; };
