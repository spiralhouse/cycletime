...
import { MigrationEngine, DefaultMigrationEngineFactory } from '../../../src/database/migrations/migration-engine'
...
import { parseSemanticVersion, formatSemanticVersion } from '../../../src/database/migrations/schema-versioning'
...
describe('Migration System Integration Tests', () => {
  ...
  describe('Complex Integration Scenarios', () => {
    it('should handle complete project lifecycle', async () => {
      ...
      expect(rollbackValidation.rollback_safety.non_reversible_migrations).toContain('004_major_refactor')
    })
  })
})